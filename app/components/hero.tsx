...
export default function Hero() {
  return (
    <main className="mx-8 h-full relative text-center flex flex-col">
      ...
      <div className="mt-6 w-fit mx-auto px-4 max-w-md flex flex-col items-center justify-center gap-4">
        ...
        <Link href="#" className="px-6 py-2 block w-fit text-lg bg-yellow-300 font-lucky rounded-tl-xl rounded-br-xl border border-black">
          Explore
        </Link>
      </div>
